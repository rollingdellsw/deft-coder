...
2. Use `/reset-reminders` command after sub-task completion
...
Fires **after** a tool completes. Can target success or failure.
...
type ReminderTrigger =
  ...
  | { type: "tool_call"; toolName: string; filePattern?: string }
  | {
      type: "tool_result";
      toolName: string;
